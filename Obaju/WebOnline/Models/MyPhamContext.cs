...
namespace WebOnline.Models
{
    public partial class MyPhamContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=tcp:obaju.database.windows.net,1433;Initial Catalog=MyPham;Persist Security Info=False;User ID=obaju;Password=Dung123456;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
